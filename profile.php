        ...
        <div class="dash-card" style="padding: 0; overflow: hidden; margin: 0;">
            ...
            <div class="profile-header-section">
                ...
                <div class="profile-actions">
                    <a href="edit_profile.php" class="btn-primary" style="background: var(--primary);">
            ...
            <div class="profile-content">
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin-bottom: 30px;">
                    ...
                    <!-- Collaborative Score -->
                    <div style="background: var(--primary-soft-2); padding: 14px; border-radius: 10px; text-align: center;">
                        <i class="fa fa-users" style="font-size: 22px; color: var(--primary-dark); margin-bottom: 8px;"></i>
                ...
                <div style="margin-bottom: 20px;">
                    <h3 style="font-size: 18px; font-weight: 700; margin-bottom: 20px; color: var(--text-dark);">
                        <i class="fa fa-users" style="color: var(--primary-dark);"></i> Collaborative Score
                    </h3>
                    
                    <!-- Overall Score Card -->
                    <div style="background: linear-gradient(135deg, var(--primary-soft), var(--primary-soft-5)); padding: 20px; border-radius: 12px; margin-bottom: 20px; display: flex; align-items: center; gap: 15px;">
                        <div style="background: white; width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                            <span style="font-size: 24px; font-weight: 700; color: var(--primary-dark);"><?= $collab_scores['avg'] ?></span>
                        </div>
                        <div>
                            <div style="font-size: 16px; font-weight: 600; color: var(--primary-ink);">Overall Average</div>
                            <div style="font-size: 13px; color: var(--primary-dark);">Based on <?= $collab_scores['count'] ?> rated subtasks</div>
                        </div>
                    </div>
