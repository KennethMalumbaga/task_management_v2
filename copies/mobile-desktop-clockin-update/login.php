...
<body class="auth-body">
      ...
      <div class="auth-container">
            ...
            <div class="auth-right">
                ...
                <form method="POST" action="app/login.php" data-tm-show-loading>
                ...
                <?php if ($googleLoginEnabled) { ?>
                    ...
                    <form method="POST" action="app/google-login.php" id="google-login-init-form" data-tm-show-loading>
      ...
      <div class="verification-modal-overlay" id="verification-modal" role="dialog" aria-modal="true" aria-labelledby="verification-title">
          <div class="verification-modal-card">
              ...
              <form method="POST" action="app/verify-login-code.php" id="verification-code-form" autocomplete="off" data-tm-show-loading>
