...
$indexes = [
    ...
    ['chats', 'idx_chats_receiver_sender_org', ['receiver_id', 'sender_id', 'organization_id', 'chat_id']],
    ['chat_attachments', 'idx_chat_attachments_chat_id', ['chat_id']],
    ['group_message_attachments', 'idx_group_msg_attachments_message', ['message_id']],
    ['group_message_reads', 'idx_group_message_reads_group_user_last', ['group_id', 'user_id', 'last_message_id']],
    ['chat_hidden_threads', 'idx_chat_hidden_user_org_type', ['user_id', 'organization_id', 'thread_type']],
    ['chat_typing_statuses', 'idx_chat_typing_direct_status', ['chat_type', 'receiver_id', 'organization_id', 'updated_at']],
    ['chat_typing_statuses', 'idx_chat_typing_group_status', ['chat_type', 'group_id', 'organization_id', 'updated_at']],
